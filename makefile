...
SRCS =  espic.c init.c  loadx.c  loadv.c  loadx_EP.c  loadv_EP.c  density.c  field.c diagnostics.c \
        plots.c  push.c  boundaries.c histories.c phiplots.c input.c tdma.c perturbation.c filtering.c


#  objects

OBJS = espic.o  init.o  loadx.o  loadv.o  loadx_EP.o  loadv_EP.o  density.o  field.o diagnostics.o \
       plots.o  push.o boundaries.o  histories.o phiplots.o input.o tdma.o perturbation.o filtering.o
